 ...
 */
package com.ottervpn.webservice.server.rest;
...
// import com.ottervpn.util.StudentUtil;
...
public class CheckPostValues {
     ...
     * @throws Throwable
     */
    @Around("target(com.ottervpn.webservice.server.rest.AbstractResource) && args(uuid,rto,..)")
     ...
     * @throws Throwable
     */
    @Around("target(com.ottervpn.webservice.server.rest.AbstractResource) && args(uuid,version) && execution(* *.delete*(..))")
